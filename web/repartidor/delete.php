        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="container">
                        <br>
                        <center><h3>¿Esta seguro de borrar a este repartidor?</h3></center>
                        <div class="card card-danger card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><span class="fa fa-users"></span> Borrar repartidor</h3>
                            </div> <!-- /.card-body -->
                            <div class="card-body">
                                <?php
                                ...
                                <form action="controller_update.php" method="post">
                                    ...
                                    <a href="controller_delete.php?email=<?php echo $email;?>" class="btn btn-danger btn-lg">Borrar Repartidor</a>
                                </form>
                            </div><!-- /.card-body -->
                        </div>
                    </div>
