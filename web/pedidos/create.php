            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="container">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <i class="fa fa-users"></i> Clientes de CyberCore
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-condensed table-bordered table-sm">
                                            ...
                                            <tr>
                                                ...
                                                <th style="background: #c0c0c0"><b>Rut</b></th>
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="rut_p"></td>
...
<script>
    $('#btn_registrar_pedido').click(function () {
        ...
        if (confirm('Esta seguro de guardar el pedido')) {
            ...
            //alert( nombre_cliente + " - "+rut_cliente+" - "+celular_cliente+" - "+celular_referencia_cliente+" - "+email_cliente+" - "+direccion_cliente+" - "+id_direccion_cliente+" - "+costo_pedido+" - "+costo_delivery+" - "+obs+" - "+id_carrito);
