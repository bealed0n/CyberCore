                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal fade"
                                                        id="exampleModal_ver_pedido<?php echo $id_pedidos;?>"
                                                ...
                                                <td>
                                                    <?php
                                                        if($id_repartidor_asignado == ""){
                                                           // echo "no esta asignado";
                                                            ?>
                                                    <select onchange="PasarVariable<?php echo $id_pedidos;?>();"
                                                        class="form-control"
                                                        id="combo_repartidor<?php echo $id_pedidos;?>">
                                                        ...
                                                        <?php
                                                                ...
                                                                foreach ($repartidores as $repartidor) {
                                                                    ...
                                                                    ?>
                                                        <option value="<?php echo $id_rep;?>"
                                                            data-icon="fa fa-motorcycle">
                                                    ...
                                                    <center>
                                                        <form action="controller_asignar_repartidor.php" method="get">
                                                            <input type="text" id="" value="<?php echo $id_pedidos;?>"
                                                                name="id_p" hidden>
                                                            <input type="text" id="txt_id_rep<?php echo $id_pedidos;?>"
                                                                name="id_r" hidden>
