                    ...
                    <div class="container">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><span class="fa fa-users"></span> Creación de un nuevo repartidor</h3>
                            </div> <!-- /.card-body -->
                            <div class="card-body">
                                <form action="controller_create.php" method="post">
                                    ...
                                    <input type="submit" class="btn btn-primary btn-lg" value="Registrar Repartidor">
                                </form>
                            </div><!-- /.card-body -->
                        </div>
                    </div>
