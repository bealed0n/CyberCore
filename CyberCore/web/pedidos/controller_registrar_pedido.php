...
$estado = "1";;
    ...
    $sentencia = $pdo->prepare("INSERT INTO tb_pedidos 
      ( nombre_cliente, rut_cliente, celular_cliente, celular_referencia_cliente, email_cliente, direccion_cliente, id_direccion_cliente, costo_pedido, costo_delivery, obs, id_carrito, fyh_creacion, estado) 
VALUES(:nombre_cliente,:rut_cliente,:celular_cliente,:celular_referencia_cliente,:email_cliente,:direccion_cliente,:id_direccion_cliente,:costo_pedido,:costo_delivery,:obs,:id_carrito,:fyh_creacion,:estado)");
